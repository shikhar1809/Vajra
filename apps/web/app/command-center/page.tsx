...
import { GenerativeMountainScene } from "@/components/mountain-scene";

// --- Components ---

const PortfolioRiskChart = ({ data }: { data: any[] }) => {
    return (
        <Card className="h-full bg-slate-900/40 backdrop-blur-md border-slate-800/50">
            <CardHeader>
                <CardTitle className="text-slate-100 flex items-center gap-2">
                    Portfolio Risk Analysis
                    <Badge variant="outline" className="ml-auto border-red-900 bg-red-950/40 backdrop-blur-sm text-red-400 animate-pulse">
        ...
        <div className="relative min-h-screen bg-black">
            ...
            <div className="relative z-10 p-8 h-full overflow-y-auto">
                    ...
                    <Button
                        ...
                        className={clsx(
                            ...
                            isFortressMode
                                ...
                                : "bg-slate-900/40 backdrop-blur-md border-slate-800 text-slate-400"
                        )}
                    >
                        {isFortressMode ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    {/* Live Threat Stream */}
                    <Card className="h-full bg-slate-900/40 backdrop-blur-md border-slate-800/50 flex flex-col">
                        <CardHeader className="pb-3 border-b border-slate-800/50">
                            <CardTitle className="text-slate-100 flex items-center justify-between text-lg">
                                ...
                                <div className="flex items-center gap-1">
                                    <div className="w-12 h-6 bg-slate-950/40 backdrop-blur-sm rounded-md border border-slate-800 relative overflow-hidden">
                    ...
                    <Card className="bg-slate-900/40 backdrop-blur-md border-slate-800/50">
                        ...
                        <CardContent>
                            <div className="space-y-4 py-4">
                                ...
                                <div className="h-4 w-full bg-slate-800/40 backdrop-blur-sm rounded-full overflow-hidden">
