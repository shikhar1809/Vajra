    ...
    return (
        <LampContainer>
            ...
            >
                ...
                >
                    <ArrowDown className="w-12 h-12 text-red-500" strokeWidth={2.5} />
                </motion.div>
                <h1 className="bg-gradient-to-br from-red-300 via-red-500 to-red-700 py-4 bg-clip-text text-center text-4xl font-bold tracking-tight text-transparent md:text-7xl">
